...
namespace Managebaker\Oauth\Controllers;

use Exception;
use Managebaker\Oauth\Events\SendingResponse;
use Managebaker\Oauth\Providers\PassportProvider;
