...
localforage.getItem("config").then(async function (config) {
  var domain = config.domain;
  var list = new Array;
  var classes
  await localforage.getItem("classes").then(
    function (value) {
      classes = value
    }
  )
